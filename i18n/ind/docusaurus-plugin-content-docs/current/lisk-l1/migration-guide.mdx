...
Sekarang kita telah mengimplementasikan kembali modul Hello dari Lisk L1 sebagai kontrak pintar di Lisk L2, maka kita bisa langsung meluncurkan kontrak Hello ke Lisk L2 dan berinteraksi dengannya.

Sebelum meluncurkan kontrak pintar ke Lisk, disarankan untuk [menguji secara lokal](#testing-the-smart-contract) dengan menulis uji yang sesuai untuk kontrak pintar yang baru dibuat.
Setelah kontrak pintar [diluncurkan](#smart-contract-deployment) ke Lisk, Anda dapat berinteraksi dengannya dengan memanggil fungsi publiknya.
...
Dengan menguji kontrak pintar, Anda dapat memverifikasi bahwa kontrak pintar berfungsi seperti yang diharapkan dan bebas dari bug, sebelum meluncurkan-nya ke Lisk.
