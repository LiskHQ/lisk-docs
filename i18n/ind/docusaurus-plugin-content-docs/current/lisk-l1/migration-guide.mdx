...
Sekarang kita telah mengimplementasikan kembali modul Hello dari Lisk L1 sebagai kontrak pintar di Lisk L2, maka kita bisa langsung deploy kontrak Hello ke Lisk L2 dan berinteraksi dengannya.

Sebelum deploy kontrak pintar ke Lisk, disarankan untuk [menguji secara lokal](#menguji-kontrak-pintar) dengan menulis uji yang sesuai untuk kontrak pintar yang baru dibuat.
Setelah kontrak pintar [di-deploy](#deployment-kontrak-pintar) ke Lisk, Anda dapat berinteraksi dengannya dengan memanggil fungsi publiknya.
...
Dengan menguji kontrak pintar, Anda dapat memverifikasi bahwa kontrak pintar berfungsi seperti yang diharapkan dan bebas dari bug, sebelum deploynya ke Lisk.
...
```
### Deployment Kontrak Pintar

Sekarang Anda dapat deploy kontrak pintar ke Lisk.
Untuk contoh ini, kami akan menggunakan jaringan Lisk Sepolia untuk deploy kontrak Hello.
...
Setelah kontrak pintar di-deploy, Anda dapat berinteraksi dengannya dengan memanggil fungsi publiknya.
