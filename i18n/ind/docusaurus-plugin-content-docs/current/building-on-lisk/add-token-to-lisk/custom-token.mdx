...
Untuk meluncurkan ke mainnet, pastikan dompet (wallet) Anda memiliki ETH yang cukup.
...
Kontrak untuk token kustom ini mewarisi (inherits) dari interface [`IOptimismMintableERC20`](https://github.com/ethereum-optimism/optimism/blob/v1.1.4/packages/contracts-bedrock/src/universal/IOptimismMintableERC20.sol) dan kontrak `ERC20`.
