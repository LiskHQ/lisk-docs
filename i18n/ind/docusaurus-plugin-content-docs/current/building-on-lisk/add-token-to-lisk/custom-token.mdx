...
Tutorial ini menggunakan [Remix](https://remix.ethereum.org) untuk deploy kontrak.
...
contract MyCustomL2Token is IOptimismMintableERC20, ERC20 {
    ...
    /// @return Apakah interface tersebut didukung oleh kontrak ini.
    function supportsInterface(bytes4 _interfaceId) external pure virtual returns (bool) {
        bytes4 iface1 = type(IERC165).interfaceId;
        // Interface yang sesuai dengan OptimismMintableERC20 terbaru (kontrak ini).
