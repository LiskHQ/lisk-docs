...
- Membaca data dari smart contract yang telah di-deploy, secara spesifik, kita akan mengambil **nama dari kontrak tersebut**.
...
Cukup scroll ke bagian `Contract ABI` dan salin ABI kontrak yang telah di-deploy.
:::
...
Gunakan cuplikan kode berikut untuk berinteraksi dengan fungsi `mint()` dari [kontrak yang telah di-deploy](https://sepolia-blockscout.lisk.com/address/0x108872F713A27bc22ca1db8CEefCAC8CbeDdF9E5?tab=write_contract).
