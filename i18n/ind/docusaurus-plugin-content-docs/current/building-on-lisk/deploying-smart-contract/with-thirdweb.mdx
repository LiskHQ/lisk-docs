...
description: "Panduan untuk meluncurkan smart contract di jaringan test Lisk menggunakan thirdweb. Termasuk instruksi untuk mengatur environment, mengompilasi, dan meluncurkan smart contract."
keywords: [
    "thirdweb",
    "smart contract",
    "ERC-721", "Lisk",
...
# Meluncurkan Smart Contract dengan thirdweb

[thirdweb](https://thirdweb.com/) adalah framework end-to-end untuk pengembangan dan peluncuran smart contract.
...
- Interact: Berinteraksi dengan smart contract dan mengintegrasikannya langsung ke dalam aplikasi Anda.
...
Langkah pertama untuk meluncurkan smart contract ke Lisk adalah menyiapkan environment pengembangan Anda dengan membuat sebuah proyek.  
...
3. Pilih `Contract` sebagai jenis proyek Anda dan berikan nama yang sesuai untuk proyek tersebut.
    ...
    ``` 
4. Selanjutnya, pilih `Forge` sebagai framework, `NFT` sebagai nama kontrak, `ERC721` sebagai jenis smart contract, dan `None` untuk opsi ekstensi.
    :::info
...
Setelah kode smart contract siap, kontrak tersebut harus di-build menggunakan thirdweb.
...
#### **Meluncurkan** Smart Contract
Semua pemeriksaan berhasil dilewati, yang berarti smart contract siap untuk diluncurkan menggunakan thirdweb.
...
5. Setelah Anda mengisi detail smart contract ERC721, klik tombol `Deploy Now` dan kontrak tersebut akan dideploy ke jaringan yang dipilih dari wallet Anda.  

:::info
Jika Anda ingin menguji kontrak berbasis Foundry Anda, ikuti langkah-langkah yang disebutkan dalam panduan [Menguji Smart Contract](/building-on-lisk/deploying-smart-contract/with-Foundry#menguji-smart-contract).
:::
