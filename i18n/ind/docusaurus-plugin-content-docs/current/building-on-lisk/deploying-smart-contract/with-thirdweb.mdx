...
[thirdweb](https://thirdweb.com/) adalah framework end-to-end untuk pengembangan dan peluncuran kontrak pintar.
...
Lebih banyak informasi tentang ini dapat ditemukan di bagian [thirdweb Explore](#meluncurkan-kontrak-bawaan-melalui-thirdweb-explore).
...
Untuk mengembangkan kontrak kustom, Anda perlu men-download dan mengonfigurasi thirdweb.  
...
Langkah pertama untuk meluncurkan kontrak pintar ke Lisk adalah menyiapkan environment pengembangan Anda dengan membuat sebuah proyek.  
...
Setelah kode kontrak pintar siap, kontrak tersebut harus di-build menggunakan thirdweb.
