...
This guide explains step-by-step how to pause your [locking position](overview#locking-positions) countdown, in order to receive more [voting power](/governance/overview#voting-power) in the Lisk DAO and to avoid that the daily [rewards](overview#staking-rewards) decrease.
