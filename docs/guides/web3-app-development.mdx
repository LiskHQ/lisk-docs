...
##### Guides
- [Deploying a smart contract with Foundry](/guides/deploying-smart-contract/with-Foundry#testing-the-smart-contract)
- [Deploying a smart contract with Hardhat](/guides/deploying-smart-contract/with-Hardhat.md)
- [Deploying a smart contract with Remix](/guides/deploying-smart-contract/with-Remix.mdx)
