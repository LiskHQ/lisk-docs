...
:::note
Before you try out the following guides, please ensure that your [wallet is connected to Lisk's Network](/lisk-chain/get-started/connecting-to-a-wallet) and it has sufficient funds in it.
For more information, see the [Wallet funds](/guides/deploying-smart-contract/with-Foundry#wallet-funds) section.
:::
...
1. For Foundry, install its [prerequisites](/guides/deploying-smart-contract/with-Foundry#prerequisites) on your system before proceeding with the creation of a thirdweb project.
...
:::info
If you want to test your Foundry-based contract, follow the steps mentioned in the [Testing the Smart Contract](/guides/deploying-smart-contract/with-Foundry#testing-the-smart-contract) guide.
:::
