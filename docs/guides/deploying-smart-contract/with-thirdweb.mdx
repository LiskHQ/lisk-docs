...
:::note
Before you try out the following guides, please ensure that your [wallet is connected to Lisk's Network](/get-started/connecting-to-a-wallet) and it has sufficient funds in it.
