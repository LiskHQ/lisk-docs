...
Please follow the [How to connect Lisk to a wallet](/lisk-chain/get-started/connecting-to-a-wallet) guide, to connect your wallet to Lisk or Lisk Sepolia network.
