...
In this tutorial you'll learn how to bridge a custom ERC-20 token from Ethereum or Sepolia to Lisk or Lisk Sepolia network, respectivley.
...
Please follow the [How to connect Lisk to a wallet](../connecting-to-a-wallet.mdx) guide, to connect your wallet to Lisk or Lisk Sepolia network.

### Get an L1 ERC-20 Token Address

You will need an L1 ERC-20 token for this tutorial.
If you already have an L1 ERC-20 token, you can skip this step.
