...
In this tutorial you'll learn how to bridge a custom ERC-20 token from Ethereum to Lisk Sepolia using the [Standard Bridge system](https://docs.optimism.io/builders/dapp-developers/bridging/standard-bridge).
...
The `mint` function allows the bridge to mint tokens to users.
...
{/* Check out the tutorial on [Bridging ERC-20 tokens to Lisk](../bridge-tokens-to-lisk) to learn how to bridge your L1 ERC-20 to Lisk using the Optimism SDK. */}
