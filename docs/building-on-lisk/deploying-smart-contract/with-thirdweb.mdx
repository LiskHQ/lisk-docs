...
:::note
Before you try out the following guides, please ensure that your [wallet is connected to Lisk's Network](/docs/connecting-to-a-wallet) and it has sufficient funds in it.
For more information, see the [Wallet funds](/docs/building-on-lisk/deploying-smart-contract/with-Foundry#wallet-funds) section.
:::
...
1. For Foundry, install its [prerequisites](/docs/building-on-lisk/deploying-smart-contract/with-Foundry#prerequisites) on your system before proceeding with the creation of a thirdweb project.
...
:::info
If you want to test your Foundry-based contract, follow the steps mentioned in the [Testing the Smart Contract](/docs/building-on-lisk/deploying-smart-contract/with-Foundry#testing-the-smart-contract) guide.
:::
