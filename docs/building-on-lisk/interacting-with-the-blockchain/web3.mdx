...
<Tabs>
  <TabItem value="ce" label="contract-example.js" default>
    ```js
    const { Web3 } = require('web3');
    ```
  </TabItem>
...
For example, you can use the ABI for the [Hello contract](https://sepolia-blockscout.lisk.com/address/0xb18eb752813c2fbedfdf2be6e5e842a85a3b8539?tab=contact_code).
