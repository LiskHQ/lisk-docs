...
<table >
  ...
  <tbody>
    <tr>
      <th scope="row" rowSpan="2">[**ERC-4337 Entrypoint**](https://github.com/ethereum-optimism/specs/blob/main/specs/protocol/preinstalls.md#erc-4337-v060-entrypoint)</th>
    ...
    <tr>
      <th scope="row" rowSpan="2">[**LegacyMessagePasser**](https://github.com/ethereum-optimism/specs/blob/main/specs/protocol/predeploys.md#legacymessagepasser)</th>
    ...
    <tr>
      <th scope="row" rowSpan="2">[**DeployerWhitelist**](https://github.com/ethereum-optimism/specs/blob/main/specs/protocol/predeploys.md#deployerwhitelist)</th>
      <td>[0x4200000000000000000000000000000000000002](https://blockscout.lisk.com/address/0x4200000000000000000000000000000000000002) </td>
      <td>🔵</td>
    </tr>
    <tr>
