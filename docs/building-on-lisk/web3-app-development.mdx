...
Account abstraction introduces an additional layer over the blockchain, which delegates most of the complexity of interacting with the blockchain to smart contracts.
