...
Before starting with the actual development of a Web3 app, you need to be clear about the following:

1. A clear idea of what you want to create with the Web3 app and what problems your application will resolve.
2. The blockchain ecosystem you want to build your Web3 app on.
The Lisk blockchain is an excellent choice for building Web3 apps, as it is fully EVM-equivalent while providing very low fees for transactions.
Additionally, Lisk is part of the superchain ecosystem, which makes it interoperabile with all other blockchains in the superchain, creating a stable and growing ecosystem for your app to live in.
3. The right app platform(s) to build your Web3 app on.
Depending on your use case and target audience, you may want to serve it through a platform that is most accessible or desired by your users.
The following sections will give you an overview of the different platforms you can choose from to build your Web3 app on.
