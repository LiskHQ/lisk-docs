...
#### Languages
Regarding languages used to build Web2 and Web3 apps, there aren't many differences.
...
However, for many use cases, there are already audited smart contracts available(see [OpenZeppelin](https://www.openzeppelin.com/solidity-contracts) or [thirdweb](https://thirdweb.com/explore)) that can be used, so developers don't always need to write their own smart contracts from scratch.
...
However, many blockcain platforms offer their own SDKs and tools to interact with their blockchain, which can make development easier and more efficient.
There are also SDKs for Web3 app development that provide a complete tech stack, like [thirdweb](https://thirdweb.com/), which take away most of the complexity of blockchain development and provide a smooth developer experience.
...
#### Data access
In Web2 apps, data is accessed through APIs.
In Web3 apps, blockchain data is accessed through smart contracts.

| Category | Web2 app development | Web3 app development |
| :------- |:-------------------- |:-------------------- |
| Tech stack | a|b |
| Languages | c| d|
| Philosophy |e |f|
