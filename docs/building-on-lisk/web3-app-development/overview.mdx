...
<Tabs queryString="web-version">
  ...
  <TabItem value="web3" label="Web3" default>
    ...
    Web 3.0 is the idea of a decentralized internet, where users are in control over their data.
    ...
    Web3 apps are built on top of blockchain technology, which allows for new features that are not possible in the Web2 world.
    The [Brave](https://brave.com/) browser for example allows users to earn cryptocurrency for viewing ads.
    Often, Web3 apps combine other cutting edge technologies like AI to provide a unique new user experience.

    Always verify, if an app upholds the Web3 standards and principles adquately - it depends on how the blockchain technology is implemented, if it is really sufficiently trustless and decentralized.
