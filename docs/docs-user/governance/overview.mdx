...
:::info
Every LSK token holder who participates in the DAO is rewarded with [staking rewards](../staking/staking#staking-rewards), to incentivize participation in the Lisk governance.
:::
