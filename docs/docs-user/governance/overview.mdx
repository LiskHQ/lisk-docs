...
:::info
Every LSK token holder who participates in the DAO is rewarded with [staking rewards](../user/staking#staking-rewards), to incentivize participation in the Lisk governance.
:::
...
### Voting power
Every account holding **LSK** is able to **stake/lock** a specific amount of LSK tokens to get some voting power and [staking rewards](../user/staking#staking-rewards).
