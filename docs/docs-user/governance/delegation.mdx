...
- [Lisk DAO Degov instance](https://lisk.degov.ai/): Check the delegate's profile, voting history, and activity on the Lisk DAO Degov instance.
...
{/* <!-- {/* - **Rewards**:
  ...
  - Being a delegate can be beneficial e.g. when applying for the Grant or Ambassador programs.
...
All you need to do is to set up a profile on the Lisk DAO Degov instance.

To get some initial [voting power](overview#voting-power), you can either: 

* stake some LSK tokens and then **self-delegate** or
* **receive delegations** from other users on your Degov profile
...
1. Fill out your delegate profile on Degov.
...
The Lisk DAO uses [Degov](https://lisk.degov.ai/) to facilitate delegation. 

The process in a nutshell:
1. Go to [Lisk DAO](https://lisk.degov.ai/) and connect your wallet to Degov. 
2. Navigate to the [Lisk DAO delegates](https://lisk.degov.ai/delegates) page.
...
:::tip
Through Degov, you can change or revoke your delegation at any time. 
:::

## How to delegate your voting power without Degov

It is crucial that members of the Lisk DAO can interact with the DAO at any point in time, even when Degov, the standard front end for the Lisk DAO, is down.
...
For a guide on how to vote manually, see the [Voting](voting) page.
