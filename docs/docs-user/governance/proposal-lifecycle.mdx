...
To get an overview about the existing delegates and their voting power, you can check the [Delegates page](https://www.tally.xyz/gov/lisk/delegates) on the Lisk DAO Tally instance.
