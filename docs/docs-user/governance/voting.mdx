...
The Lisk DAO uses [Degov](https://lisk.degov.ai/) to facilitate the voting on proposals. 

The process in a nutshell:
1. Go to [Lisk DAO](https://lisk.degov.ai/) and connect your wallet to Degov. 
2. Navigate to the [Lisk DAO proposals](https://lisk.degov.ai/proposals) page.
  <img src={voteList}/>
