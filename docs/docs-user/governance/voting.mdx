...
It contains the information, but also just with numbers 0, 1 or 2 and not with yes, no or abstain.

[^1]: At the time of writing, there was an issue with connecting MetaMask to blockscout on Firefox; you may have to use another browser like Brave or Chrome
