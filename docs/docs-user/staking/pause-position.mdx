---
title: How to pause a locking position
sidebar_position: 4
...
This guide explains ste-by-step how to pause your [locking position](staking#locking-positions) countdown, in order to receive more [voting power](governance/overview#voting-power) in the Lisk DAO.

:::tip
Pausing your locking position can [boost your voting power](governance#boosting-the-voting-power) up to **200%**.
:::
