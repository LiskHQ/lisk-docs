---
title: How to extend the duration of a stake
sidebar_position: 4
...
This guide explains ste-by-step how to extend the duration of the countdown of a particular [locking position](overview#locking-positions).
...
4. Set the amount of weeks you want to extend the countdown of the current locking position.
    ...
    Additionally, you can preview the amount of voting power you will gain by extending the locking position duration.
    :::
4. Confirm the spending cap in your wallet.
