...
import claim from '../../../static/img/docs/staking/claim-ui.png';
import claimApprove from '../../../static/img/docs/staking/claim-approve.png';

<div className="imageCaption">
  <p>Image1: _Staking at the Lisk Portal_</p>
...
6. **Approve the staking by clicking the `Approve` button.** <img src={approve} />
  Before you can stake your LSK tokens, you need to approve the spending cap for the Staking contract in your wallet.
7. **Create the locking position by clicking the `Stake` button.** <img src={stake} />
...
<div className="imageCaption">
  <p>_Image2: Staking confirmation message_</p>
  <img src={staked}  alt="Confirmation" width="50%"/>
</div>
...
After at least one day of staking, you should see an accumulated amount of your [staking rewards](staking#staking-rewards) you received until then.
...
3. **Connect your Lisk wallet** to the Lisk Portal, if you haven't already.
4. **Select the network you want to stake on.** 
  This should be either `Lisk` or `Lisk Sepolia Testnet`.
5. **Click the `Claim Rewards` button.**
6. **Verify your rewards ready to be claimed.**<br />
  <img src={claimApprove} width="60%"/>
7. **Click the `Claim Rewards` button.**
8. **Approve the transaction in your wallet** to complete the claiming process.
...
3. **Connect your Lisk wallet** to the Lisk Portal, if you haven't already.
4. **Select the network you want to unstake on.** 
  This should be either `Lisk` or `Lisk Sepolia Testnet`.
5. **Select the expired locking position** you wish to unstake and follow the described process.
