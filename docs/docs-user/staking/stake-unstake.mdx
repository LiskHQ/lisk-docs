...
6. **Approve the staking by clicking the `Approve` button.** <img src={approve} width="80%"/>
  Before you can stake your LSK tokens, you need to approve the spending cap for the Staking contract in your wallet.
7. **Create the locking position by clicking the `Stake` button.** <img src={stake} width="80%"/>
...
After at least one day of staking, you should see the accumulated amount of [staking rewards](staking#staking-rewards) that you are eligible for until then.
