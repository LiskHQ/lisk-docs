...
2. **Enter the amount of LSK you wish to stake.**
  ![image](../../../static/img/docs/staking/amount.png)
3. **Set the locking period.**
  ![image](../../../static/img/docs/staking/duration.png)
4. **Approve the staking.**
  ![image](../../../static/img/docs/staking/approve-small.png)
  ![image](../../../static/img/docs/staking/set-cap.png)
  ![image](../../../static/img/docs/staking/approve-cap.png)
5. **Create the locking position.**
  ![image](../../../static/img/docs/staking/stake.png)
  ![image](../../../static/img/docs/staking/create-position.png)


That's it! 🎉 You have now successfully taked your LSK tokens.

![image](../../../static/img/docs/staking/staked.png)
