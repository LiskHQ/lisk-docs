...
6. **Click the `Stake` button.**<br />
    <img src={stake} width="80%"/><br />
    This will prompt you to initiate the stake and to approve the spending cap for the staking contract.
7.  **Approve the spending cap by clicking the `Approve` button.** <br />
    You can skip this step if you already approved a higher or the same spending cap for the staking contract during a previous stake.<br />
    <img src={approve} width="60%"/><br />
    Confirm the spending cap for the Staking contract in your wallet.
8. **Create the locking position by clicking the `Stake` button.**<br />
...
After at least one day of staking, you should see the accumulated amount of [staking rewards](staking.md#staking-rewards) that you are eligible for until then.
