...
This guide explains ste-by-step how to unstake a [locking position](overview#locking-positions) before it has expired.
...
6. A prompt will show up confirming the early unlock was successfull.
