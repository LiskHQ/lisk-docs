...
If you haven't used this plugin before and are not seeing the double check icon in the sidebar, you first have to [activate](https://remix-ide.readthedocs.io/en/latest/unittesting.html) it from Remix plugin manager.
