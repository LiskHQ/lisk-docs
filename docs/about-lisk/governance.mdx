...
- Users can modify their locking positions (increase amount, pause locking duration) at any time they want.
...
### Proposals
Proposal are created on [Tally](#tally).
...
Users can lock tokens for a specific locking duration (between 2 weeks and 2 years).
...
We consider to transition to a voting-escrow-Token model at some point.
