...
The Lisk DAO has an associated treasury, which resides in the [TimelockController contract](https://sepolia-blockscout.lisk.com/address/0x4b727D3f74DD4c124Ced030335DebD5e7EBB8366).
...
| **General** |  General proposals about protocol parameters or the project direction in general that may be followed by the Lisk Foundation or not, depending also on feasibility and cost.  | No  |
...
We apply a **time-weight boosting** on rewards:
