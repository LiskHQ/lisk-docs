...
:::tip
Every LSK token holder who participates in the DAO government is rewared with staking rewards, to incentivize participation in the Lisk DAO.
:::
...
Locking positions are represented using NFTs, similar to liquidity positions in Uniswap v3.
This would be useful for composability into DeFi and potential future uses. 
...
### Delegation
The Governor framework also requires to delegate the voting power in order to use it.
