...
title: Introduction
slug: /
description: The official Lisk documentation. Lisk is a Layer 2 blockchain designed for builders in high-growth markets — providing the ecosystem, support, and resources they need to launch and scale.
