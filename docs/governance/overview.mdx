...
Please go to the [Delegation](governance/delegation) page to find out more about the delegation process, including guides how to delegate and how to become a delegate.
