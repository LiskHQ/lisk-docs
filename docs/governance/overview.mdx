...
:::note
The DAO fund may be increased further in the future by an additional 100,000,000 LSK over the following 7 years (2026-2033) if the DAO members approve the corresponding proposals.
:::

### Voting power
Every account holding **LSK** is able to **stake/lock** a specific amount of LSK tokens to get some voting power and [staking rewards](#staking-rewards).
