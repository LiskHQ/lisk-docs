...
### Treasury
The Lisk DAO has an associated treasury, which resides in the [Timelock](https://blockscout.lisk.com/address/0x2294A7f24187B84995A2A28112f82f07BE1BceAD) contract.
The current balance of the treasury can be checked on the [Lisk BlockScout Explorer](https://blockscout.lisk.com/address/0x2294A7f24187B84995A2A28112f82f07BE1BceAD?tab=tokens_erc20).
...
In short, users get [voting power](#voting-power) and rewards for staking tokens for a specific time period.
...
*/}
Rewards are taken from the balance of the [Rewards contract](https://github.com/LiskHQ/lisk-contracts/blob/main/documentation/staking-governance.md#contracts-overview) and calculated daily, based on the amount locked and the remaining locking duration.
...
A total of 24 million LSK tokens are used over the course of 3 years for the LSK staking rewards program (8 million LSK per year).
