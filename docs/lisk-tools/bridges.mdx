...
The [Superbridge](https://superbridge.app/support/lisk-mainnet) enables you to bridge ETH and other supported assets from Ethereum mainnet (L1) directly to Lisk.
...
## Relay
Relay offers an alternative method for bridging ETH to the Lisk network.
