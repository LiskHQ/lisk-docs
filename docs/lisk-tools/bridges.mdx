...
The [Superbridge](https://superbridge.app/support/lisk-mainnet) enables you to bridge ETH and other supported assets from the Ethereum mainnet (L1) directly to Lisk and vice versa.
